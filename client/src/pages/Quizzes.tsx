...
export default function Quizzes() {
  ...
  const hasNoQuizzes = !isLoading && difficulty === "All" && quizzesList?.length === 0;
  ...
  return (
    <div className="min-h-screen flex flex-col bg-[#0b101b] text-[#f3e9d2]">
      ...
      <main className="flex-1 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16 w-full">
        ...
        ) : hasNoMatches || hasNoQuizzes ? (
          <div role="status" aria-live="polite" className="text-center py-20 text-sm text-[#f3e9d2]/60">
            {hasNoMatches ? "No quizzes match the selected difficulty." : "No quizzes are available yet."}
          </div>
        ) : (
